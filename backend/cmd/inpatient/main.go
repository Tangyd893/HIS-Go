...
func setupInpatientRouter(cfg *config.Config, inpatientHandler *handler.InpatientHandler) *gin.Engine {
	...
	router.GET("/health", func(c *gin.Context) {
		c.JSON(http.StatusOK, gin.H{"status": "UP", "service": "his-inpatient"})
	})
