...
func main() {
	...
	router := setupClinicRouter(cfg, clinicHandler, deps, jwtSvc)
...
func setupClinicRouter(cfg *config.Config, clinicHandler *handler.ClinicHandler, deps *health.Dependencies, jwtSvc *jwt.JWTService) *gin.Engine {
