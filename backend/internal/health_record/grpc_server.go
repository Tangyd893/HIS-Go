...
func (s *HealthRecordGrpcServer) RevokeAuthorization(ctx context.Context, req *health_record.RevokeAuthorizationRequest) (*common.BaseResponse, error) {
	if err := s.svc.RevokeAuthorization(req.PatientId, req.DoctorId); err != nil {
		return nil, err
	}
